...
from config import (
    OCCAM_RESULTS_PATH, OUTPUT_PATH,
...
pm.plot()
model_out = os.path.join(OUTPUT_PATH, f'resistivity_model_iter{ITER_NUMBER:02d}.png')
...
pr.plot()
pr.save_figures(OUTPUT_PATH, fig_dpi=150)
print(f"✓ Response plots saved to: {OUTPUT_PATH}")
